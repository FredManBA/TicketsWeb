...
$router->add('GET', '/users/{id}/deactivate', 'UserController@deactivate');
$router->add('GET', '/users/{id}/activate', 'UserController@activate');
$router->add('POST', '/users/{id}/deactivate', 'UserController@deactivate');
$router->add('POST', '/users/{id}/activate', 'UserController@activate');
...
$router->add('GET', '/user/dashboard', 'TicketController@userDashboard');
$router->add('GET', '/user/tickets/{id}', 'TicketController@showUserTicket');
$router->add('POST', '/user/tickets/{id}/accept', 'TicketController@acceptSolution');
$router->add('POST', '/user/tickets/{id}/reject', 'TicketController@rejectSolution');
$router->add('GET', '/user/tickets/create', 'TicketController@create');
$router->add('POST', '/user/tickets', 'TicketController@store');
$router->add('POST', '/user/tickets/{id}/comment', 'TicketController@addUserComment');

// Operator dashboard routes
$router->add('GET', '/operator/dashboard', 'TicketController@operatorDashboard');
$router->add('POST', '/operator/tickets/{id}/assign', 'TicketController@assignTicket');
$router->add('GET', '/operator/tickets/{id}', 'TicketController@showOperatorTicket');
$router->add('POST', '/operator/tickets/{id}/update', 'TicketController@update');

// Admin dashboard routes
$router->add('GET', '/admin/dashboard', 'TicketController@adminDashboard');
$router->add('GET', '/admin/tickets/{id}', 'TicketController@showAdminTicket');
